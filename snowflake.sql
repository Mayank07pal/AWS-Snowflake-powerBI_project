 CREATE OR REPLACE STORAGE INTEGRATION PBI_Integration
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::680476617526:role/powerbi.role1'
  STORAGE_ALLOWED_LOCATIONS = ('s3://powerbi.project0718/')
...
//drop database test;
DROP STAGE POWERBI.PBI_DATA.PBI_STAGE;

create stage POWERBI.PBI_DATA.PBI_STAGE
url = 's3://powerbi.project0718'
